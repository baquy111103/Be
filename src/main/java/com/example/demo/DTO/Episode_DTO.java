...
public class Episode_DTO {
    ...
    public Episode_DTO(Integer episode_number, String description, String video_url, Double duration, String release_date, Boolean status, String movie_code, String movie_name) {
